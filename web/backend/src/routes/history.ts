...
import { TemperatureIn, TemperatureOut, Humidity, Pressure, IWeatherData } from '../../models/WeatherData';
...
router.get('/temperature_in', async (req, res, next) => await handleQuery(req, res, TemperatureIn, next))

router.get('/temperature_out', async (req, res, next) => await handleQuery(req, res, TemperatureOut, next))
